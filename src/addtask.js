...
export function addTask(taskname, tasdesc, taskdate, project, priority) {
  //create a new task for the todo list
  ...
  if (projectArrays.hasOwnProperty(project)) {
    //if the project already exists, add the task to the project
